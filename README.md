...
### Примеры запросов
   ...
   **Вывод списка всех мероприятий:**
    ...
    Параметр from - проводится поиск мероприятий начинающихся с этой даты. Формат даты в виде 2026-06-15T10:00:00Z
    Параметр to - проводится поиск мероприятий заканчивающихся в эту дату. Формат даты в виде 2026-06-17T10:00:00Z
